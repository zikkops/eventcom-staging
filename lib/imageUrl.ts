...
/** ImageKit photos at `width`; local files in public/ are served as they are. */
export const sizedImage = (src: string, width: number) =>
  isImageKitUrl(src) ? imagekitSized(src, width) : src;

/** "https://ik.imagekit.io/<account>/eventcom/photo.jpg" → "/eventcom/photo.jpg" */
